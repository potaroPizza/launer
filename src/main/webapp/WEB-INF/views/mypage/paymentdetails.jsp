		...
		<div class="paymentdetails_container">
			<ul class="paymentdetails_table">
				<li class="paymentdetails_table-header">
					...
					<div class="paymentdetails_col-3">결제금액</div>
				...
				<li class="paymentdetails_table-row"> 
					...
					<div class="paymentdetails_col-3" data-label="결제금액"></div>
				...
				<c:if test="${!empty list }">
					<c:forEach var="vo" items="${list }">
			            ...
			            <c:if test="${fn: length(title)<=8}">
							...
							<div class="paymentdetails_col-3" data-label="결제금액"><fmt:formatNumber value="${vo.paymentViewVO.totalPrice}" pattern="#,###"></fmt:formatNumber>원</div>
