...
<t:wrapper>
	...
	<div id="detailedPaymentHistory_wrap">
		...
		<div class="detailedPaymentHistory_sub">
			...
			<p>
				총 결제금액 &nbsp;&nbsp;&nbsp;&nbsp;<span><fmt:formatNumber value="${list[0].paymentHistoryViewVO.totalPrice}" pattern="#,###,###,###"></fmt:formatNumber> 원</span>
			</p>
		</div>
		<hr>
							...
							<table class="detailedPaymentHistory-table">
								<thead class="thead-primary">
									<tr>
										...
										<th id="detailedPaymentHistory_col3">결제금액</th>
										...
										<td>
											<div class="detailedPaymentHistory-explain">
												<span>${vo2.paymentHistoryViewVO.categoryName } </span>
												 <span>수량:${vo2.paymentHistory.get(st.index).QUAN	 }
												   </span>
											</div>
										</td>
