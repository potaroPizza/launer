...
<t:wrapper>
	<link href="<c:url value="/css/reset.css"/>" rel="stylesheet"
		type="text/css" />
	<script src="https://kit.fontawesome.com/d4af3bb512.js"
	...
	<div id="mypage_wrap">
		...
		<div class="mypage_introduce">
			${vo.name }님, &nbsp;<span>러너와</span> <span>함께</span> <span>빨래</span><span>없는</span>
			<span>생활을</span> <span>시작</span><span>하세요!</span>
		...
		<div id="mypage-main-wrap" class="clearfix">
			<div class="part">
				<a href="/launer/mypage/mypoint"> <i class="fa-solid fa-coins"></i>
					<div class="hover-wrap"></div>
					<div class="event-box"></div>
				</a>
			</div>
			<div class="part">
				<a href="/launer/mypage/paymentdetails"> <i
					class="fa-solid fa-file-invoice"></i>
					<div class="hover-wrap"></div>
				</a>
			</div>
			<div class="part">
				<a href="/launer/mypage/myinfo"> <i
		...
		<div id="mypage-text-wrap" class="clearfix">
			<div class="part">
				<span><fmt:formatNumber value="${vo.point}"
						pattern="#,###,###,###"></fmt:formatNumber> Point</span>
			</div>
			<div class="part">
				<span>결제내역</span>
			</div>
